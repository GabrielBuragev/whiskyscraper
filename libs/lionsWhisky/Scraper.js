...
var logger = require("../logger")('LionsWhisky');
var Product = require('./Product');
var Datastore = require('nedb');
var db = new Datastore({ filename: 'db/lionswhiskyProducts.db', autoload: true });
...
var Scrapy = function() {
    ...
    var URL = {
        baseURL: 'http://www.lionswhisky.com',
        newsPath: '/new_arrivals.php',
        createURL: function() {
    ...
    var parseAndStoreElementsFromHTML = function(html) {
        ...
        return new Promise((resolve, reject) => {
            var htmlProducts = $('div.product-list table tbody tr');
            ...
            htmlProducts.each(function() {
                ...
                var product = new Product({
                    ...
                    imgURL: $(this).find('td img.image').attr('src'),
                    price: $(this).find('td.price').text(),
                    available: (this.price == self.outOfStockLabel) ? (false) : (true),
                });
